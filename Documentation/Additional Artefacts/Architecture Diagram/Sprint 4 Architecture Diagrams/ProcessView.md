...
### 1. Analytics Page
![Analytics Page](../../../../images/reports.png)  
...
![Admin change clinic hours](../../../../images/Admin_Change.png)  
The Admin change clinic hours activity diagram illustrates how administrators can change or set the clinic operating hours by navigating to the clinic management page, where the system fetches all the clinics and allows real-time updates of clinic operating hours.

---
### 4. Patient Booking according to staff availability 
![Patient Booking](../../../../images/Patient_Book.png)  
The Patient Booking activity diagram illustrates how patients book appointments due to staff availability, where the system checks if selected clinic is open and if staff is available for that slot or time of day.
